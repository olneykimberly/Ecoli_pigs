...
## ----read_object-----------------------------------------------------------------------------------------------------
# read object
dataObject.astrocyte <- readRDS(paste0("snRNAseq/rObjects/", projectID, "_astrocyte.rds"))
dataObject.oligodendrocyte <- readRDS(paste0("snRNAseq/rObjects/",projectID,"_oligodendrocyte.rds"))
dataObject.polydendrocyte<- readRDS(paste0("snRNAseq/rObjects/",projectID,"_polydendrocyte.rds"))
dataObject.endothelial <- readRDS(paste0("snRNAseq/rObjects/",projectID,"_endothelial.rds"))
dataObject.fibroblast <- readRDS(paste0("snRNAseq/rObjects/",projectID,"_fibroblast.rds"))
dataObject.mural<- readRDS(paste0("snRNAseq/rObjects/",projectID,"_mural.rds"))
dataObject.microglia <- readRDS(paste0("snRNAseq/rObjects/",projectID,"_microglia.rds"))
dataObject.neuron <- readRDS(paste0("snRNAseq/rObjects/",projectID,"_neuron.rds"))
dataObject.ependyma <- readRDS(paste0("snRNAseq/rObjects/",projectID,"_ependyma.rds"))
# 
# ## ----clean_objects-----------------------------------------------------------------------------------------------------
...
#  clean
 ...
 saveRDS(dataObject.clean, paste0("snRNAseq/rObjects/",projectID,"_clean.rds"))
#  dirty
 ...
 saveRDS(dataObject.dirty, paste0("snRNAseq/rObjects/",projectID,"_dirty.rds"))

## ----read_in_clean_data-----------------------------------------------------------------------------------------------------
# Read in clean data
dataObject.clean <- readRDS(paste0("snRNAseq/rObjects/",projectID,"_clean.rds"))
...
# Save 
saveRDS(dataObject.clean, paste0("snRNAseq/rObjects/",projectID,"_after_recluster_before_integration_SCTransform.rds"))
#dataObject.clean <- readRDS(paste0("snRNAseq/rObjects/",projectID,"_merged_reclusters_clean_SCTransform.rds"))


#----- plot UMAPS
# group 
pdf(paste0("snRNAseq/results/UMAP/unannotated/", projectID,
...
path <- paste0("snRNAseq/results/UMAP/annotated/",projectID,
               "_harmony_integrated_annoated_Azimuth_after_recluster")
ditto_umap
saveToPDF(paste0(path, ".pdf"), width = 12, height = 8)

## ----save_integrated-----------------------------------------------------------------------------------------------------
saveRDS(dataObject.integrated, paste0("snRNAseq/rObjects/",projectID,"_after_recluster_harm_int.rds"))
## -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------