...
for (i in allcelltypes) {
  ind1_vs_ind2 <- read.delim(paste0("snRNAseq/results/DEGs/DESeq2_pseudobulk_exp_filter/", i, "_Ecoli_vs_Saline_comparison_pseudobulk.txt"))
  ...
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    ...
    pdf(paste0("snRNAseq/results/volcanoes/DESeq2_pseudobulk_exp_filter/", i, "_Ecoli_vs_Saline.pdf"), height = 7, width = 7)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
# All samples 
for (i in cell_types) {
  filepath <- paste0("snRNAseq/results/DEGs/DESeq2_pseudobulk_exp_filter/", i, "_Ecoli_vs_Saline_comparison_pseudobulk.txt")
...
write.xlsx(list_of_datasets, file = paste0(
    "snRNAseq/results/DEGs/DESeq2_pseudobulk_exp_filter/Ecoli_vs_Saline.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "snRNAseq/results/DEGs/DESeq2_pseudobulk_exp_filter/Ecoli_vs_Saline_qval0.05_abslogFC1_up_regulated.xlsx"))
...
write.xlsx(list_of_datasets, file = paste0(
    "snRNAseq/results/DEGs/DESeq2_pseudobulk_exp_filter/Ecoli_vs_Saline_qval0.05_abslogFC1_down_regulated.xlsx"))
```
...
file_path <- "snRNAseq/results/DEGs/DESeq2_pseudobulk_exp_filter/Ecoli_vs_Saline_qval0.05_abslogFC1_up_regulated.xlsx"
...
path <- paste0("snRNAseq/results/UpSet/Ecoli_vs_Saline_qval0.05_abslogFC1_up_regulated")
saveToPDF(paste0(path, ".pdf"), width = 8, height = 5)

# Binary table with colnames:
write.table(
  data, "snRNAseq/results/UpSet/Ecoli_vs_Saline_qval0.05_abslogFC1_up_regulated.txt",
  sep = "\t",
  quote = FALSE
)
...
## Downregulated 
# Load Excel file and get sheet names
file_path <- "snRNAseq/results/DEGs/DESeq2_pseudobulk_exp_filter/Ecoli_vs_Saline_qval0.05_abslogFC1_down_regulated.xlsx"
sheets <- excel_sheets(file_path)
...
path <- paste0("snRNAseq/results/UpSet/Ecoli_vs_Saline_qval0.05_abslogFC1_down_regulated")
saveToPDF(paste0(path, ".pdf"), width = 8, height = 5)

# Binary table with colnames:
write.table(
  data, "snRNAseq/results/UpSet/Ecoli_vs_Saline_qval0.05_abslogFC1_down_regulated.txt",
  sep = "\t",
  quote = FALSE
)
```
...
for (i in cell_types) {
  filepath <- paste0("snRNAseq/results/DEGs/DESeq2_pseudobulk_exp_filter/", i,
  ...
  #path <- paste0("snRNAseq/results/gprofiler/", i, "_up_and_down_gprofiler")
  ...
  write.table(up_names, paste0("snRNAseq/results/gprofiler/", 
                               i, "_up_gene_descriptions.txt"), 
              sep = "\t", quote = FALSE, row.names = FALSE)
  write.table(down_names, paste0("snRNAseq/results/gprofiler/", 
  ...
  # output table 
  write.table(gp_mod, paste0("snRNAseq/results/gprofiler/", i, "_up_and_down_gp_mod_enrich.txt"), 
              sep = "\t", quote = FALSE, row.names = FALSE)
...
write.table(gp_mod, paste0("snRNAseq/results/gprofiler/", i, "_up_gene_char.txt"), 
              sep = "\t", quote = FALSE, row.names = FALSE)
...
write.table(gp_mod, paste0("snRNAseq/results/gprofiler/", i, "_down_gene_char.txt"), 
              sep = "\t", quote = FALSE, row.names = FALSE)
...
path_up <- paste0("snRNAseq/results/gprofiler/", i, "_up_gprofiler")
...
path_down <- paste0("snRNAseq/results/gprofiler/", i, "_down_gprofiler")
...
path_comb <- paste0("snRNAseq/results/gprofiler/", i, "_up_and_down_gprofiler")
