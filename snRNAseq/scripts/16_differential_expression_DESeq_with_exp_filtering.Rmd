...
pseudo_bulk_meta <- dataObject.pseudo@meta.data
    ...
    dds <- DESeq(dds)
    res <- results(dds, contrast = c("group", "Saline", "Ecoli")) ## swapped because the samples were missed labelled :(
...
pdf(paste0("snRNAseq/results/pca/PMI_DESeq2_psuedobulk_cell_type.pdf"), height = 5, width = 6.5)
