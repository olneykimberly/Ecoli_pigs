...
# Save 
saveRDS(dataObject, paste0("snRNAseq/rObjects/",projectID,"_SCTransform.rds"))
dataObject <- readRDS(paste0("snRNAseq/rObjects/",projectID,"_SCTransform.rds"))
...
# Save r object - FINAL
```{r save_integrated}
saveRDS(dataObject.integrated, paste0("snRNAseq/rObjects/",projectID,"_FINAL.rds"))
```