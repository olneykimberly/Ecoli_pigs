...
for (i in allComparisons) {
  group1_vs_group2 <-
    read.delim(paste0("snRNAseq/results/DEGs/DESeq2_pseudobulk_exp_filter/", i,"_Ecoli_vs_Saline_comparison_pseudobulk.txt"))
    i <- gsub("_", " ", i)
  color_values <- vector()
...
up_enrich_results <-
  read_excel(
    paste0(
      "snRNAseq/results/metascape/astrocyte_up/metascape_result.xlsx"
    ), sheet = 2
  )
...
down_enrich_results <-
  read_excel(
    paste0(
      "snRNAseq/results/metascape/astrocyte_down/metascape_result.xlsx"
    ), sheet = 2
  )
...
up_enrich_results <-
  read_excel(
    paste0(
      "snRNAseq/results/metascape/VLMC_up/metascape_result.xlsx"
    ), sheet = 2
  )
...
down_enrich_results <-
  read_excel(
    paste0(
      "snRNAseq/results/metascape/VLMC_down/metascape_result.xlsx"
    ), sheet = 2
  )
...
up_enrich_results <-
  read_excel(
    paste0(
      "snRNAseq/results/metascape/oligodendrocyte_up/metascape_result.xlsx"
    ), sheet = 2
  )
...
down_enrich_results <-
  read_excel(
    paste0(
      "snRNAseq/results/metascape/oligodendrocyte_down/metascape_result.xlsx"
    ), sheet = 2
  )
...
up_enrich_results <-
  read_excel(
    paste0(
      "snRNAseq/results/metascape/opc_up/metascape_result.xlsx"
    ), sheet = 2
  )
...
down_enrich_results <-
  read_excel(
    paste0(
      "snRNAseq/results/metascape/opc_down/metascape_result.xlsx"
    ), sheet = 2
  )
