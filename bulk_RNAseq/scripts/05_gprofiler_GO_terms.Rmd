...
for (i in allComparisons) {
  filepath <- paste0("bulk_RNAseq/results/DEGs/", i,
    "_q0.05_lfc0.25.txt")
  df <- assign(paste0(i),
         tryCatch(
         read.delim(
  ...
  path <- paste0("bulk_RNAseq/results/gprofiler/", i, "_up_and_down_gprofiler")
  ...
  write.table(up_names, paste0("bulk_RNAseq/results/gprofiler/", 
                               i, "_up_gene_descriptions.txt"), 
              sep = "\t", quote = FALSE, row.names = FALSE)
  write.table(down_names, paste0("bulk_RNAseq/results/gprofiler/", 
  ...
  # output table 
  write.table(gp_mod, paste0("bulk_RNAseq/results/gprofiler/", i, "_up_and_down_gp_mod_enrich.txt"), 
              sep = "\t", quote = FALSE, row.names = FALSE)
}
```
...
plot_up
path <- paste0("bulk_RNAseq/results/gprofiler/", i, "_up_gprofiler")
...
plot_down
path <- paste0("bulk_RNAseq/results/gprofiler/", i, "_down_gprofiler")
pdf(paste0(path, ".pdf"), height = 6, width = 8)
print(plot_down)
dev.off()
```
...
path <- paste0("bulk_RNAseq/results/manuscript_figures/Supplemental_Figure_Ecoli_vs_Saline_bulkRNA_gProfiler_bubble")
saveToPDF(paste0(path, ".pdf"), width = 8.5, height = 11)
```

# CPM data
```{r}
dge.filtered.norm <- readRDS("bulk_RNAseq/rObjects/dge.filtered.norm.4vs4.rds")
...
path <- paste0("bulk_RNAseq/results/manuscript_figures/Supplemental_Figure_Ecoli_vs_Saline_bulkRNA_gp_downregulated_heatmaps")
