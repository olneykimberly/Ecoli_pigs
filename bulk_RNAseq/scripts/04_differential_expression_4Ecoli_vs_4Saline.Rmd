...
Compare Saline vs Saline between project LPS and project Ecoli
...
count_files <-
  file.path(paste0(
    brain_metadata$path,
    brain_metadata$counts_name,
    "_",
    typeOfCount
  ))
# add sample counts name to the counts files
names(count_files) <- paste0(brain_metadata$counts_name)
# Inspect 
table(brain_metadata$sample) # Some samples have technical replicates. 
...
sumTable
write.table(sumTable, paste0("../results/DEGs/DEGs_summary_q0.05_log2FC0.25.txt"), quote = FALSE, sep = "\t")
...
for (i in allComparisons) {
  ...
  vTopTableSig <-
    topTable( 
      ...
      genelist = genes_relevant, 
      confint = TRUE)
  path <- paste0("../results/DEGs/", i, "_q0.05_lfc0.25.txt", sep = "") 
